...
from hftcryptoapi import __version__

from .common_types import RawData
...
class BaseStream:
    ...
    def __init__(self, endpoint: str, api_key: str, secret_key: str, raw_data: bool = False, websocket_params: Optional[Dict] = None,) -> None:
        """
        Args:
    ...
    async def _connect(self) -> None:
        ...
        extra_headers = {
            ...
            "User-Agent": "HFTCRYPTO/" + __version__,
        }
        ...
        try:
            ...
            err_data = 90002
            raise ValueError("Expected data message not received, error: ", err_data)
    ...
    async def _start_ws(self, channel_type="public") -> None:
